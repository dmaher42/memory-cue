...
6. `src/ui/mobileMemoryCoachUi.js` runs contextual retrieval, clue, reveal, and self-rating in the dedicated Coach view. `js/services/recall-service.js` calculates due items and the next interval without another AI call.
